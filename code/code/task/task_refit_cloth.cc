...
//      "task_refit_cloth.cc" - Moving a finished piece onto another slot
//
//////////////////////////////////////////////////////////////////////////
...
static void refit_cloth_pulse(TBeing* ch) {
...
int task_refit_cloth(TBeing* ch, cmdTypeT cmd, const char*, int pulse, TRoom*,
  TObj*) {
