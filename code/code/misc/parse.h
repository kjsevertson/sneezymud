...
extern void half_chop_safe(const char* sstring, char* arg1,
  unsigned int arg1Len, char* arg2, unsigned int arg2Len);
#define half_chop(s, a1, a2) \
  half_chop_safe(s, a1, cElements(a1), a2, cElements(a2))
...
extern bool is_abbrev(const char*, const char*,
  multipleTypeT multiple = MULTIPLE_NO, exactTypeT exact = EXACT_NO);
extern bool is_abbrev(const sstring&, const sstring&,
  multipleTypeT multiple = MULTIPLE_NO, exactTypeT exact = EXACT_NO);
