...
TaskEntry tasks[NUM_TASKS] = {
  ...
  {"skulking", "You are too busy skulking.\n\r", task_skulk},
  {"setting a trap", "You are too busy setting your trap.\n\r",
    task_trap_portal},
  {"serrating a weapon", "You are too busy filing teeth into a weapon.\n\r",
    task_serrate},
  {"jamming a door", "You are too busy wedging your blade into the door.\n\r",
    task_jam},
  {"casting a key", "You are too busy working wax into the lock.\n\r",
    task_keycut},
  {"stripping a piece of armor", "You are too busy stripping armor.\n\r",
    task_strip},
  {"plating a piece of armor", "You are too busy plating armor.\n\r",
    task_plate},
  {"sewing", "You are too busy sewing.\n\r", task_sew},
  {"working metal down", "You are too busy working metal down.\n\r",
    task_bangle},
  {"smelting", "You are too busy at the crucible.\n\r", task_smelt},
  {"combining ingots", "You are too busy at the forge.\n\r",
    task_combine},
  {"forging armor", "You are too busy at the anvil.\n\r", task_forge},
  {"calling a soul", "You are too busy calling.\n\r", task_ensoul},
  {"saying the rites", "You are too busy with the rites.\n\r",
    task_rites},
  {"bolstering armor", "You are too busy bolstering.\n\r",
    task_bolster},
  {"distilling", "You are too busy distilling.\n\r", task_distill},
  {"resizing armor", "You are too busy at the anvil.\n\r", task_resize},
  {"tailoring", "You are too busy sewing.\n\r", task_tailor},
  {"weaving", "You are too busy weaving.\n\r", task_weave},
  {"infusing", "You are too busy infusing.\n\r", task_infuse},
  {"transmuting", "You are too busy transmuting.\n\r",
    task_transmute},
