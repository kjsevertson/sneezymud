...
namespace {
  std::map<spellNumT, sstring> spellNumToName = {
    ...
    {SKILL_PLATE, "SKILL_PLATE"},
    {SKILL_BANGLE, "SKILL_BANGLE"},
    {SKILL_ENSOUL, "SKILL_ENSOUL"},
    {SKILL_TAILOR, "SKILL_TAILOR"},
    {SKILL_WEAVE, "SKILL_WEAVE"},
    {SKILL_MINE, "SKILL_MINE"},
    {SKILL_DISTILL, "SKILL_DISTILL"},
    {SKILL_INFUSE, "SKILL_INFUSE"},
    {SKILL_TRANSMUTE, "SKILL_TRANSMUTE"},
    {SKILL_SEW, "SKILL_SEW"},
    {SKILL_FORGE, "SKILL_FORGE"},
    {SKILL_SMELT, "SKILL_SMELT"},
    {SKILL_RITES, "SKILL_RITES"},
    {SKILL_BOLSTER, "SKILL_BOLSTER"},
