...
extern int task_repair_organic(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
extern int task_repair_wood(TBeing*, cmdTypeT, const char*, int, TRoom*, TObj*);
extern int task_repair_magical(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
extern int task_repair_rock(TBeing*, cmdTypeT, const char*, int, TRoom*, TObj*);
extern int task_repair_gem(TBeing*, cmdTypeT, const char*, int, TRoom*, TObj*);
...
extern int task_repair_spirit(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
...
extern int task_spell_friends(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
...
extern int task_trap_container(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
extern int task_trap_mine(TBeing*, cmdTypeT, const char*, int, TRoom*, TObj*);
extern int task_trap_grenade(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
...
extern int task_createEngine(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
...
extern int task_stavecharging(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
extern int task_trance_of_blades(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
...
extern int task_extinguish_my_ass(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
extern int task_butchering(TBeing*, cmdTypeT, const char*, int, TRoom*, TObj*);
extern int task_handgonne_load(TBeing*, cmdTypeT, const char*, int, TRoom*,
  TObj*);
extern int task_cannon_load(TBeing*, cmdTypeT, const char*, int, TRoom*, TObj*);
extern int task_trap_arrow(TBeing*, cmdTypeT cmd, const char*, int, TRoom*,
  TObj*);
